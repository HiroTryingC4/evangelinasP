...
import { calcPaymentStatus, calcRemaining, parseYMDToUTCDate, toYMD, hasUnitTimeConflict } from "@/lib/utils";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const checkIn  = parseYMDToUTCDate(body.checkIn);
    const checkOut = parseYMDToUTCDate(body.checkOut);
